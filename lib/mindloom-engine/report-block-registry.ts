...
export const ENGINE_REPORT_BLOCK_REGISTRY: EngineReportBlockDefinition[] = [
  ...
  { id: 'business_impact', order: 14, title: 'Как это может влиять на решения и работу', status: 'hidden', feedbackEnabled: false, sourceFields: ['semantic_map.affordances', 'field', 'graph'], hiddenReason: 'requires_business_prompt_layer', requires: ['business_prompt_layer'] },
