...
export const FIXED_BLOCKS_REPAIR_PROMPT =
  ...
  '  "attention_route": {\n' +
  '    "steps": [\n' +
  '      { "label": "Сигнал", "text": "Что замечает внимание в первую очередь — ситуация, ощущение, слово." },\n' +
  '      { "label": "Что внимание замечает", "text": "На что внимание реагирует быстро — обычно это связано с главным паттерном." },\n' +
  '      { "label": "Какой смысл собирается", "text": "Интерпретация, которая возникает автоматически." },\n' +
  '      { "label": "Какая реакция появляется", "text": "Действие или состояние, которое запускается вслед за этим." }\n' +
  '    ]\n' +
  '  },\n' +
  '  "attention_blind": {\n' +
  '    "items": [\n' +
  '      { "title": "Собственная усталость", "text": "Формулировка мягко — что может становиться менее заметным." },\n' +
  '      { "title": "Помощь со стороны", "text": "Что может выпадать из фокуса, когда внимание занято главным паттерном." },\n' +
  '      { "title": "Ценность без функции", "text": "Что труднее заметить, когда внимание занято." }\n' +
  '    ]\n' +
  '  },\n' +
  '  "business_impact": {\n' +
  '    "areas": [\n' +
  '      { "title": "В решениях", "text": "Как паттерн может отражаться на принятии решений." },\n' +
  '      { "title": "В делегировании", "text": "Как паттерн может влиять на передачу ответственности." },\n' +
  '      { "title": "В команде", "text": "Как паттерн может влиять на взаимодействие с командой." }\n' +
  '    ],\n' +
  '    "strengths": ["Высокая надёжность", "Внимание к деталям"],\n' +
  '    "risks": ["Перегруз", "Трудность делегирования"]\n' +
  '  },\n' +
  '  "feedback_config": {\n' +
  '    "enabled": false,\n' +
  ...
  '- attention_route — опциональное поле. Покажи, куда внимание может уходить первым, что оно замечает, какой смысл быстро собирается и какая реакция появляется. 3–5 коротких шагов. Пиши как гипотезу, без терминов.\n' +
  '- attention_blind — опциональное поле. Покажи, что может оставаться вне фокуса, когда внимание занято главным паттерном. 3–5 простых пунктов. Формулируй мягко: "может становиться менее заметным", "труднее заметить".\n' +
  '- business_impact — опциональное поле. Покажи, как паттерн может отражаться на работе: решения, делегирование, команда, коммуникация. Добавь сильную сторону и риск. Без бизнес-жаргона, без диагнозов.';
