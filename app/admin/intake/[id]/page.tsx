...
const MINDLOOM_PROMPT_PREFIX =
  ...
  '      { "label": "Что внимание замечает", "text": "На что внимание реагирует быстро — обычно связано с главным паттерном." },\n' +
  ...
  '  "attention_blind": {\n' +
  '    "items": [\n' +
  '      { "title": "Собственная усталость", "text": "Формулируй мягко — что может становиться менее заметным." },\n' +
  '      { "title": "Помощь со стороны", "text": "Что может выпадать из фокуса, когда внимание занято главным паттерном." },\n' +
  '      { "title": "Ценность без функции", "text": "Что труднее замечать, когда внимание занято." }\n' +
  '    ]\n' +
  '  },\n' +
  '  "business_impact": {\n' +
  '    "areas": [\n' +
  '      { "title": "В решениях", "text": "Как паттерн может отражаться на принятии решений — из материала." },\n' +
  '      { "title": "В делегировании", "text": "Как паттерн влияет на передачу ответственности." },\n' +
  '      { "title": "В команде", "text": "Как паттерн влияет на взаимодействие с командой." }\n' +
  '    ],\n' +
